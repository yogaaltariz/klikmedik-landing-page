...
var LocationMap = /*#__PURE__*/function () {
  function LocationMap(id, view, zoomLevel) {
    _classCallCheck(this, LocationMap);

    this.id = id;
    this.view = view;
    this.zoomLevel = zoomLevel;
    this.tokenMap = 'pk.eyJ1IjoieW9nYWFsdGFyaXoiLCJhIjoiY2tjdzI3M3k0MDl1ejJ2bGE0Y3l0M3FoeCJ9.4t6IoUSf2tqc1hjdRC7KhQ';
    this.L = L;
...
var HQ = new LocationMap('hq-map', [5.548290, 95.323753], 13).init();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "37929" + '/');
